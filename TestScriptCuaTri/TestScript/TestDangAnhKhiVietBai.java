...
public class TestDangAnhKhiVietBai {
  WebDriver driver;
  	...
  	public void TestCase() throws InterruptedException, AWTException {
  		...
  		Thread.sleep(2000);
  		driver.findElement(By.xpath("//li[@class='ce-toolbox__button' and @data-tool='image']")).click();
  		Thread.sleep(2000);
  		driver.findElement(By.xpath("//div[contains(@class, 'cdx-button') and contains(@class, 'btn-upload')]")).click();
  		Thread.sleep(2000);
      
  		StringSelection duongdanfile = new StringSelection("F:\\tester.jpg");
        Toolkit.getDefaultToolkit().getSystemClipboard().setContents(duongdanfile, null);
        Thread.sleep(3000);
